...
export class RequestController {
	...
	@Get('byField')
	async findByField(@Res() res: Response, @Query() body: RequestGetByFieldDto): Promise<Response> {
		try {
	...
	async detail(
		...
		try {
			const data: IRequestConvert = await this.requestServices.findDetail(param)
			return ServerResponse.success(res, {
				data
			})
		} catch (error) {
	...
	@Post('')
	async sendRequest(@Res() res: Response, @Req() req: Request, @Body() body: RequestDto): Promise<Response> {
		try {
